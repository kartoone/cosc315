...
insert into users (role_id, username, "password") values (2,'sally',crypt('test4444', gen_salt('bf')));
insert into users (role_id, username, "password") values (3,'wendys',crypt('test1111', gen_salt('bf')));
